    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Свежий воздух 24/7 */}
            <div className="group relative bg-gradient-to-br from-blue-50 to-white rounded-3xl p-8 overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
            ...
            <div className="group relative bg-gradient-to-br from-purple-50 to-white rounded-3xl p-8 overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
            ...
            <div className="group relative bg-gradient-to-br from-green-50 to-white rounded-3xl p-8 overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
            ...
            {/* Работает бесшумно */}
            <div className="group relative bg-gradient-to-br from-amber-50 to-white rounded-3xl p-8 overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
            ...
            <div className="group relative bg-gradient-to-br from-teal-50 to-white rounded-3xl p-8 overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
            ...
            <div className="group relative bg-gradient-to-br from-indigo-50 to-white rounded-3xl p-8 overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <div className="max-w-4xl mx-auto mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="bg-white/60 backdrop-blur-sm p-6 rounded-xl shadow-md hover:shadow-xl transition-all transform hover:-translate-y-1">
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 via-blue-50/30 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="mt-12 max-w-4xl mx-auto bg-gradient-to-r from-aeronix-blue/10 via-blue-50 to-green-50 p-8 rounded-2xl border-2 border-aeronix-blue/20 shadow-lg">
        ...
        <div className="container mx-auto px-4 text-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:+77750808448" className="border-2 border-white px-10 py-4 rounded-lg font-semibold hover:bg-white/10 transition transform hover:scale-105 flex items-center justify-center gap-2">
